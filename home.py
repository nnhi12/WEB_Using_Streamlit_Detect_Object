...
import Picture_chappter3 as c3
...
def main():
    ...
    if 'options_3' not in st.session_state:
        st.session_state.options_3 = ['Negative', 'Power', 'Logarit', 'PiecewiseLinear', 'Histogram', 'HistEqual', 'HistEqualColor',
