...
from Phat_Hien_Doi_Tuong_Yolo8_streamlit import home as phdt
import home as hm
...
def show_home():
    st.header("Name: Lỷ Toàn Phát ")
    st.header("Name: Nguyễn Thị Hồng Thắm")
    st.header("Student ID: 21110910")
    st.header("Student ID: 21110654")
...
def show_about():
    st.header("About")
    st.write("Đây là sản phẩm báo cáo cuối kỳ của sinh viên Lỷ Toàn Phát và Nguyễn Thị Hồng Thắm môn Xử lý ảnh số")
